...
# Master script allégé : échantillonnage, folds réduits, hyperparams light, GPU par défaut.
# GPU_REQUIRED=0 pour forcer le mode CPU.
...
export TMP_TRAIN_CFG TMP_PARAMS_CFG

echo "=> Entraînement (light)..."
